...
#else
	Log.Out(EQEmuLogSys::Detail, EQEmuLogSys::General, "Starting EQStreamFactoryWriterLoop");
#endif
	fs->WriterLoop();
...
#else
	Log.Out(EQEmuLogSys::Detail, EQEmuLogSys::General, "Ending EQStreamFactoryWriterLoop");
#endif
