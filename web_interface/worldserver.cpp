...
void WorldServer::OnConnected(){
	Log.DoLog(EQEmuLogSys::Detail, EQEmuLogSys::WebInterface_Server, "Connected to World.");
...
void WorldServer::Process(){
	...
	while((pack = tcpc.PopPacket())){
		Log.DoLog(EQEmuLogSys::Detail, EQEmuLogSys::WebInterface_Server, "Received Opcode: %4X", pack->opcode);
		switch(pack->opcode) {
			case 0: { break; }
