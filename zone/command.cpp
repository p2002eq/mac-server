...
int command_init(void){
	...
	*/
	if
		...
		command_add("details", "- Change the details of your target (Drakkin Only)", 255, command_details) ||
		...
		command_add("tattoo", "- Change the tattoo of your target (Drakkin Only)", 255, command_tattoo) ||
