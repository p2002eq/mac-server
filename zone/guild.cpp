...
void Client::SendGuildList() {
	...
	Log.DoLog(EQEmuLogSys::Detail, EQEmuLogSys::Guilds, "Sending OP_GuildsList of length %d", outapp->size);
...
void Client::SendPlayerGuild() {
	...
	Log.DoLog(EQEmuLogSys::Detail, EQEmuLogSys::Guilds, "Sending OP_GuildAdded of length %d", outapp->size);
