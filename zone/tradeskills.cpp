...
void Client::CheckIncreaseTradeskill(uint16 success_modifier, SkillUseTypes tradeskill)
{
	...
	logger.DebugCategory(EQEmuLogSys::Detail, EQEmuLogSys::Tradeskills, "...skillup_modifier: %f , success_modifier: %d , twoStatPenalty: %d", skillup_modifier, success_modifier, twoStatPenalty);
